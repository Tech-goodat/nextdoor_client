    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-white border rounded-full py-3 pl-12 pr-4 outline-none focus:ring-2 focus:ring-lime-400"
        />
      </div>
      ...
      {/* Count */}
      <p className="text-gray-600 font-medium mb-6 uppercase tracking-wide">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          {filteredBusinesses.map((business) => (
            <div
              key={business.id}
              className="bg-white border border-gray-200 rounded-3xl p-5 flex items-center justify-between hover:shadow-md transition"
            >

...
const Home = () => {
  ...
  const categories = useMemo(() => {
    const uniqueCategories = [
      ...new Set(
        businesses.map((business) => business.business_type).filter(Boolean)
      ),
    ];
  ...
  const filteredBusinesses = businesses.filter((business) => {
    ...
    const matchesCategory =
      selectedCategory === "All" || business.business_type === selectedCategory;
